...
PROJECT_ID              = "cra-nps-project_id-dev"
REGION                  = "asia-south1"
...
ROUTER_NAME             = "cra-nps-router-dev"
CLOUD_NAT_NAME          = "cra-nps-nat-dev"

## Artifact Registry Configuration ##
ARTIFACT_REGISTRY_NAME  = "cra-nps-artifact-registry-dev"
ARTIFACT_REGISTRY_KEEP_COUNT = "10"

## GKE ##
CLUSTER_NAME            = "cra-nps-cluster-dev"
...
## KMS ##
KMS_KEY_RING_NAME       = "cra-nps-kms-keyring-dev"
KMS_KEY_NAME            = "cra-nps-kms-key-dev"

## Bucket ##
BUCKET_NAME             = "cra-nps-bucket-dev"

## Compute Engine ##
COMPUTE_ENGINE_NAME     = "cra-nps-compute-engine-dev"
...
DOMAIN_NAME             = "cra-nps-dev-proteantech.in"